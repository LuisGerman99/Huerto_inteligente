...
class LineChart extends Component {
    ...
    state = { //json de descripcion de la grafica
        line1: {
            ...
            name: 'Presion',
            fill: 'tozeroy',
            fillcolor: '#f88', //Color del fill
            marker: {
                color: '#FF4141', //Color de la linea
                line: {
                    color: '#FF4141', //Color de la bolita
                    width: 2
                },
            },
        },
    ...
    componentDidMount() { //Si carga bien el programa, refrescarla cada 1000 ms
        ...
        fetch('https://hello-world-c1c6d-default-rtdb.firebaseio.com/Sensors/Huerto/Temperatura.json').then(response => {
