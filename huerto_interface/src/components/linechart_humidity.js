...
class LineChart extends Component {
    ...
    state = { //json de descripcion de la grafica
        line1: {
            ...
            name: 'Presion',
            fill: 'tozeroy',
            fillcolor: '#99D9EA', //Color del fill
            marker: {
                color: '#3E98C7', //Color de la linea
                line: {
                    color: '#3E98C7', //Color de la bolita
                    width: 2
                },
            },
        },
    ...
    componentDidMount() { //Si carga bien el programa, refrescarla cada 1000 ms
        ...
        fetch('https://hello-world-c1c6d-default-rtdb.firebaseio.com/Sensors/Huerto/Humedad.json').then(response => {
